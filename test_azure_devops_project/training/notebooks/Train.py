...
# ``test_azure_devops_project/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "experiment_name",
    f"/dev-test-azure-devops-project-experiment",
    label="MLflow experiment name",
)
# Unity Catalog registered model name to use for the trained model.
dbutils.widgets.text(
    "model_name", "dev.test_project_schema_name.test-azure-devops-project-model", label="Full (Three-Level) Model Name"
)
