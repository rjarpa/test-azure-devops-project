...
Opening a pull request will trigger a[Azure DevOps Pipeline](../.azure/devops-pipelines/test-azure-devops-project-tests-ci.yml)
...
* [Staging workspace registered model](https://adb-your-staging-workspace.azuredatabricks.net#mlflow/models/staging-test-azure-devops-project-model)
* [Prod workspace registered model](https://adb-your-prod-workspace.azuredatabricks.net#mlflow/models/prod-test-azure-devops-project-model)
