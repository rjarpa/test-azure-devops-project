...
```
test-azure-devops-project        <- Root directory. Both monorepo and polyrepo are supported.
│
├── test_azure_devops_project       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
